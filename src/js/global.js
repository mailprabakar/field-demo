// These modules are required on all pages.
// If a module is only needed for one or a few pages, don't import it here.
import "jquery";
import "bootstrap";
import "lazysizes";
import "./calendly.js";
...
(function ($) {
  ...
  var removePreloader = function () {
    console.log("Setting up fade out function for our loader animation...");
    $(window).on("load", function () {
    ...
    // This is our fallback in case the load event is never called.
    // setTimeout(function () {
    //   $(".loader").fadeOut();
    //   $("#loading-overlay")
    //     .delay(100)
  ...
  console.log("Running removePreloader()...");
  removePreloader();
